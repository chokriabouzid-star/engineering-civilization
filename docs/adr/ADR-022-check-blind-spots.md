...
مبدأ نقاء الـKernel محترم: لا تغييرات تنتهك القيود (لا I/O ولا async أُضيفا)
5. البدائل المرفوضة
...
نقل منطق تجميع الـcrate إلى ec-analysis: مرفوض — مبدأ نقاء الـKernel يحصر
معرفة نظام الملفات وI/O في ec-cli.

---

## بند مفتوح: توثيق مبدأ نقاء الـKernel

- **المشكلة:** مبدأ "نقاء الـKernel" (لا I/O، لا async) مُطبّق فعلياً ويُستشهد به في ADRs، لكنه لم يُمنح وثيقة ADR رسمية مستقلة.
- **الإجراء المقترح:** توثيقه كـ ADR-023 في أقرب فرصة (Phase 3.2 أو ما بعدها).
- **حالة البند:** مفتوح، أولوية متوسطة.
